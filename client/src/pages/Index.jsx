  ...
  return (
    <div className="bg-[#18191b] min-h-screen w-full">
      <div
        ...
        } transition-all duration-500 ease-in-out h-screen fixed bg-[#252627ad] flex justify-center items-center`}
      >
        <div className="w-[350px] bg-[#323335] m-auto px-6 py-4 rounded-md relative">
          ...
          {type === "signin" && (
            <form>
              ...
              <div>
                <button className="px-3 py-2 rounded-md bg-purple-500 w-full ounline-none hover:bg-purple-600 text-white">
                  Sign in
                </button>
              </div>
